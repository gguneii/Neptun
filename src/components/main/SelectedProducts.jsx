        ...
        <div className="flex gap-2 justify-center">
          <div className="bg-white border-[1px] rounded-md flex flex-col items-center justify-center w-full md:w-auto">
            ...
            <div className="w-[200px] h-[200px] relative">
              <img className="object-cover" src="../src/assets/ovsyanka.jpg" alt="" />
            ...
            <h3 className="text-[0.65rem] font-semibold mb-4 px-4 text-center">AXA 40GR KASA OVSYANAYA MESE GILEMEYVESI</h3>
          ...
          <div className=" hidden lg:flex bg-white border-[1px] rounded-md flex-col items-center justify-center">
            <div className="flex w-[80%] mt-4 justify-end">
              <div className="w-[21.6px] h-[22px]">
                <svg
                  className="fill-transparent object-cover stroke-[#ff8230] stroke-[8.07px] hover:fill-[#ff8230] duration-200"
