    ...
    <div className="bg-gray-100 h-full">
      <div className="max-w-[1200px] mx-auto py-4">
        ...
        <div className="flex gap-3">
          ...
          <div className="bg-white border-[1px] rounded-md flex flex-col items-center justify-center w-[200px]">
            ...
            <div className=" relative w-[100px] h-[140px] ">
              <img className="object-cover" src="../src/assets/abc.webp" alt="" />
            ...
            <h3 className="text-[0.65rem] font-semibold mb-4 px-4 text-center">ABC 750GR BULASIQ DETERJANI LIMON FERAHLIGI</h3>
            <h2 className="text-[1.3rem] font-bold">2.90</h2>
